...
4. Create or update the file in `spec-bot/standards/[folder]/`
...
1. Scan `spec-bot/standards/` for all `.md` files
...
3. Update `spec-bot/standards/index.yml`:
...
All standards: `spec-bot/standards/[folder]/[standard].md`
Index file: `spec-bot/standards/index.yml`
